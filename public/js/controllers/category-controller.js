adminSystem.controller("CategoryController", CategoryController);

function CategoryController($scope, $rootScope, $http) {
    ...
    function update(news) {
        ...
        $http.put(url, news).then(function mySuccess(response) {
            if (response.data.status && response.data.status == 'successful') {
